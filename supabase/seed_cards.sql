...
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ...
  ((SELECT id FROM banks WHERE name = 'HDFC Bank'), 'Shoppers Stop', 500, 500, 'mid', 'Lifestyle'),
  ...
  ((SELECT id FROM banks WHERE name = 'HDFC Bank'), 'Diners Club Miles', 1000, 1000, 'mid', 'Travel'),
  ...
  ((SELECT id FROM banks WHERE name = 'HDFC Bank'), '6E Rewards', 1500, 1500, 'mid', 'Travel'),
  ((SELECT id FROM banks WHERE name = 'HDFC Bank'), 'UPI RuPay Credit Card', 0, 0, 'entry', 'Cashback'),
  ((SELECT id FROM banks WHERE name = 'HDFC Bank'), 'BIZ Black', 10000, 10000, 'super_premium', 'Business')
...
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ...
  ((SELECT id FROM banks WHERE name = 'ICICI Bank'), 'MakeMyTrip Credit Card', 500, 500, 'mid', 'Travel'),
  ((SELECT id FROM banks WHERE name = 'ICICI Bank'), 'HPCL Super Saver', 500, 500, 'entry', 'Fuel'),
  ((SELECT id FROM banks WHERE name = 'ICICI Bank'), 'Manchester United', 499, 499, 'mid', 'Lifestyle'),
  ((SELECT id FROM banks WHERE name = 'ICICI Bank'), 'Expressions', 199, 199, 'entry', 'Lifestyle'),
  ((SELECT id FROM banks WHERE name = 'ICICI Bank'), 'Times Black', 20000, 20000, 'super_premium', 'Lifestyle'),
...
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ...
  ((SELECT id FROM banks WHERE name = 'SBI Card'), 'BPCL Octane', 1499, 1499, 'mid', 'Fuel'),
  ((SELECT id FROM banks WHERE name = 'SBI Card'), 'BPCL SBI Card', 499, 499, 'entry', 'Fuel'),
  ((SELECT id FROM banks WHERE name = 'SBI Card'), 'Yatra SBI Card', 1499, 1499, 'mid', 'Travel'),
  ((SELECT id FROM banks WHERE name = 'SBI Card'), 'IRCTC SBI Platinum', 1500, 1500, 'mid', 'Travel'),
...
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ...
  ((SELECT id FROM banks WHERE name = 'Axis Bank'), 'Vistara Axis Bank', 1500, 1500, 'mid', 'Travel'),
  ((SELECT id FROM banks WHERE name = 'Axis Bank'), 'Vistara Infinite', 10000, 10000, 'super_premium', 'Travel'),
  ((SELECT id FROM banks WHERE name = 'Axis Bank'), 'Burgundy Private', 0, 0, 'super_premium', 'Lifestyle'),
  ((SELECT id FROM banks WHERE name = 'Axis Bank'), 'Reserve', 50000, 50000, 'super_premium', 'Lifestyle')
ON CONFLICT (bank_id, card_name) DO NOTHING;

-- ---- American Express ----
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ((SELECT id FROM banks WHERE name = 'American Express'), 'Platinum Card', 60000, 66000, 'super_premium', 'Lifestyle'),
...
-- ---- Kotak Mahindra Bank ----
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ((SELECT id FROM banks WHERE name = 'Kotak Mahindra Bank'), 'White Reserve', 10000, 10000, 'super_premium', 'Lifestyle'),
  ...
  ((SELECT id FROM banks WHERE name = 'Kotak Mahindra Bank'), 'Solitaire', 15000, 15000, 'super_premium', 'Lifestyle')
ON CONFLICT (bank_id, card_name) DO NOTHING;
...
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ...
  ((SELECT id FROM banks WHERE name = 'Yes Bank'), 'Yes First Business', 999, 999, 'mid', 'Business'),
  ((SELECT id FROM banks WHERE name = 'Yes Bank'), 'Yes ACE', 499, 499, 'mid', 'Cashback'),
  ((SELECT id FROM banks WHERE name = 'Yes Bank'), 'Yes Prosperity Business', 499, 499, 'mid', 'Business'),
  ...
  ((SELECT id FROM banks WHERE name = 'Yes Bank'), 'Yes Wellness', 499, 499, 'mid', 'Lifestyle'),
  ((SELECT id FROM banks WHERE name = 'Yes Bank'), 'BYOC', 49, 49, 'entry', 'Rewards')
ON CONFLICT (bank_id, card_name) DO NOTHING;

-- ---- RBL Bank ----
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ((SELECT id FROM banks WHERE name = 'RBL Bank'), 'Lumière', 50000, 50000, 'super_premium', 'Lifestyle'),
  ...
  ((SELECT id FROM banks WHERE name = 'RBL Bank'), 'World Safari Lite', 1000, 1000, 'mid', 'Travel'),
...
-- ---- IndusInd Bank ----
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ((SELECT id FROM banks WHERE name = 'IndusInd Bank'), 'Pinnacle', 14999, 14999, 'super_premium', 'Lifestyle'),
  ...
  ((SELECT id FROM banks WHERE name = 'IndusInd Bank'), 'IndusInd Tiger', 599, 599, 'mid', 'Lifestyle'),
  ...
  ((SELECT id FROM banks WHERE name = 'IndusInd Bank'), 'EazyDiner Platinum', 1499, 1499, 'mid', 'Lifestyle'),
  ((SELECT id FROM banks WHERE name = 'IndusInd Bank'), 'Club Vistara Explorer', 1500, 1500, 'mid', 'Travel')
ON CONFLICT (bank_id, card_name) DO NOTHING;

-- ---- IDFC First Bank ----
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ((SELECT id FROM banks WHERE name = 'IDFC First Bank'), 'FIRST Private', 50000, 50000, 'super_premium', 'Lifestyle'),
  ...
  ((SELECT id FROM banks WHERE name = 'IDFC First Bank'), 'Club Vistara IDFC', 1500, 1500, 'mid', 'Travel'),
...
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ...
  ((SELECT id FROM banks WHERE name = 'Standard Chartered'), 'EaseMyTrip', 0, 0, 'mid', 'Travel')
ON CONFLICT (bank_id, card_name) DO NOTHING;
...
-- ---- Federal Bank ----
INSERT INTO master_cards (bank_id, card_name, default_joining_fee, default_annual_fee, tier, category) VALUES
  ((SELECT id FROM banks WHERE name = 'Federal Bank'), 'Scapia', 0, 0, 'mid', 'Travel'),
